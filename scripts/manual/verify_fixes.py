...
# Add the repo root so backend.app imports resolve when running the script directly.
...
def test_language_normalization():
    ...
    try:
        from backend.app.transcription.transcription_worker import normalize_language_code
...
def test_ollama_health_check():
    ...
    try:
        from backend.app.translation.translator import check_ollama_health
...
def test_language_detection():
    ...
    try:
        from backend.app.translation.translator import detect_language
